...
module ProxyCrawlerServices
  # Crawls a single site using proxy: navigates to homepage, extracts links, processes articles
  class SiteCrawler < ApplicationService
    def initialize(site:, proxy_client:)
      @site = site
    ...
    def call
      ...
      links = extract_article_links(doc)
