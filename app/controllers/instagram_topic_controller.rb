...
class InstagramTopicController < ApplicationController
  ...
  def show
    ...
    assign_instagram_data(dashboard_data[:instagram_data])
  ...
  def entries_data
    ...
    render partial: 'shared/error_message',
           locals: { message: 'Error cargando publicaciones de Instagram. Por favor intente nuevamente.' },
  ...
  def assign_instagram_data(data)
